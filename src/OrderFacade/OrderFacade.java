...
public class OrderFacade {
    ...
    public void cancelOrder(int orderid) throws SQLException {
        ...
        LocalDate acceptanceDate = LocalDate.from(order.getAcceptanceDateFromDatabase(orderid));
        ...
        if (acceptanceDate != null) {
            long daysDifference = ChronoUnit.DAYS.between(acceptanceDate, LocalDateTime.now());
    ...
    public void cancelOrderItem(int orderID, int itemID) throws SQLException {
        ...
        if (acceptanceDate != null) {
            long daysDifference = ChronoUnit.DAYS.between(acceptanceDate, LocalDateTime.now());
            System.out.println("Hours difference: " + daysDifference);
